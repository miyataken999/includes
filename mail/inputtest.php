	...
	<form action="./action/send.php" method="post" accept-charset="utf-8" class="container" id="send_form">
		...
		<div class="form-row form-group">
			<div class="col">
				...
				<input type="text" class="form-control" id="to_addrInput" name="to_addrInput" value="<?=$replace_data["Eoc"]["mail1"]?>" >
			</div>
			<div class="col">
				<label class="control-label" for="cc_addrInput">Ccアドレス</label>
				<input type="text" class="form-control" id="cc_addrInput" name="cc_addrInput" value="<?=$replace_data["Eoc"]["mail2"]?>" >
			</div>
			<div class="col">
