...
class TestCase_E1_0051
{
    ...
    public function set()
    {
        ...
        $this->iraiMailAddress = 'nishitani-あいうおえ-urlounge.co.jp'; // 必須:×項番:1-7-1-20階層:4属性:半角文字桁数:320桁数:320項目名:依頼主メールアドレス備考:
