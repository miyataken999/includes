...
class TestCase_E8_0001
{
    ...
    public function set()
    {
        ...
        $this->otodokeAdd1 = ''; // 必須:◎項番:1-7-1-4階層:4属性:指定なし桁数:25桁数:25項目名:届先住所1備考:半角/全角問わず、25文字まで印字可能
        $this->otodokeAdd2 = ''; // 必須:×項番:1-7-1-5階層:4属性:指定なし桁数:25桁数:25項目名:届先住所2備考:半角/全角問わず、25文字まで印字可能
        $this->otodokeAdd3 = ''; // 必須:×項番:1-7-1-6階層:4属性:指定なし桁数:25桁数:25項目名:届先住所3備考:半角/全角問わず、25文字まで印字可能
