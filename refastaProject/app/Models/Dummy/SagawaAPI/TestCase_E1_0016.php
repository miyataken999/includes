...
class TestCase_E1_0016
{
    ...
    public function set()
    {
        ...
        $this->iraiNm1 = 'lkfjasldgjskghs;lhglskgjhslgnksdgsldjklk'; // 必須:○項番:1-7-1-16階層:4属性:指定なし桁数:25桁数:25項目名:依頼主氏名1備考:依頼主指定フラグが1の場合必須 ---半角/全角問わず、25文字まで印字可能
