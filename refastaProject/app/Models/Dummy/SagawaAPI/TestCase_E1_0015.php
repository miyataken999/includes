...
class TestCase_E1_0015
{
    ...
    public function set()
    {
        ...
        $this->iraiAdd1 = 'fd_dfdf;hjskfhslkhsgkjhsdgjkhs'; // 必須:○項番:1-7-1-13階層:4属性:指定なし桁数:25桁数:25項目名:依頼主住所1備考:依頼主指定フラグが1の場合必須 ---半角/全角問わず、25文字まで印字可能
