...
class TestCase_E1_0088
{
    ...
    public function set()
    {
        ...
        $this->shukaIraiShiteiTimeCode = 'a'; // 必須:×項番:1-7-1-47-3階層:5属性:半角文字桁数:2桁数:2項目名:集荷依頼時間指定コード備考:集荷依頼の場合必須 ---5.1.パラメータコード定義参照
