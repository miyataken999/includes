...
class TestCase_E1_0041
{
    ...
    public function set()
    {
        ...
        $this->iraiTel = '08065294996-jh'; // 必須:○項番:1-7-1-19階層:4属性:半角文字桁数:20桁数:20項目名:依頼主電話番号備考:依頼主指定フラグが1の場合必須 ---数字またはハイフン
