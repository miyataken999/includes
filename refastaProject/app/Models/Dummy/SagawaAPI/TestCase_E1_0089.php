...
class TestCase_E1_0089
{
       ...
       public function set()
    {
        ...
        $this->shukaIraiShiteiDate = 'jhgdfk'; // 必須:×項番:1-7-1-47-2階層:5属性:半角文字桁数:8桁数:8項目名:集荷依頼指定日備考:集荷依頼の場合必須 ---yyyyMMdd
