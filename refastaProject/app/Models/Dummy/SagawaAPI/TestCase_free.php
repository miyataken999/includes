...
class TestCase_free
{
    ...
    public function set()
    {
        ...
        $this->iraiYubin = '1700fds013'; // 必須:○項番:1-7-1-18階層:4属性:半角数字桁数:7桁数:7項目名:依頼主郵便番号備考:依頼主指定フラグが1の場合必須 ---ハイフンなし
        $this->iraiTel = '0806529fdsa4996'; // 必須:○項番:1-7-1-19階層:4属性:半角文字桁数:20桁数:20項目名:依頼主電話番号備考:依頼主指定フラグが1の場合必須 ---数字またはハイフン
        $this->iraiMailAddress = 'nishitani@urlounge.co.jp'; // 必須:×項番:1-7-1-20階層:4属性:半角文字桁数:320桁数:320項目名:依頼主メールアドレス備考:
        $this->shukaIraiShiteiDate = '202fdsa10822'; // 必須:×項番:1-7-1-47-2階層:5属性:半角文字桁数:8桁数:8項目名:集荷依頼指定日備考:集荷依頼の場合必須 ---yyyyMMdd
