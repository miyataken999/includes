...
// <okuriCode>N01-asgfhu;s</okuriCode>
// <outputLevel>000</outputLevel>
// <resultCode>E1-0047</resultCode>
// <printDataList>
// <printDataDetail>
// <userManageNumber>20150626092404</userManageNumber>
// <resultCodeList>
// <resultCode>E1-0096</resultCode>
// </resultCodeList>
// </printDataDetail>
// </printDataList>
// </shippingResponse>
...
class TestCase_E1_0047
{
    ...
    public function set()
    {
        ...
        $this->okuriCode = 'N01-asgfhu;s'; // 必須:○項番:1-4階層:2属性:半角文字桁数:20桁数:20項目名:送り状コード備考:送り状の帳票コードを設定 ---5.1.パラメータコード定義書参照 ---送り状発行依頼フラグが1の場合、指定必須
        ...
        $this->motoChakuCode = '1'; // 必須:○項番:1-7-1-46階層:f4属性:半角数字桁数:1桁数:1項目名:元着コード備考:配送料金の支払い方法を設定 ---5.1.パラメータコード定義参照
