...
class TestCase_E1_0042
{
    ...
    public function set()
    {
        ...
        $this->otodokeAdd1 = '東京都豊島区東池袋-ghjkdsfjhkfgsghfjksgfhjks'; // 必須:◎項番:1-7-1-4階層:4属性:指定なし桁数:25桁数:25項目名:届先住所1備考:半角/全角問わず、25文字まで印字可能
