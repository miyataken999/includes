...
class TestCase_E1_0039
{
    ...
    public function set()
    {
        ...
        $this->iraiYubin = '1700013_ldkfjhgkdghf'; // 必須:○項番:1-7-1-18階層:4属性:半角数字桁数:7桁数:7項目名:依頼主郵便番号備考:依頼主指定フラグが1の場合必須 ---ハイフンなし
