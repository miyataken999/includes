...
class TestCase_E1_0043
{
    ...
    public function set()
    {
        ...
        $this->otodokeNm1 = '宅配買取事業部-flsdjhlk;jglkdfjhgkldfhgkljdhgfkdjlgfhdkjlgfhldsh'; // 必須:◎項番:1-7-1-7階層:4属性:指定なし桁数:25桁数:25項目名:届先氏名1備考:半角/全角問わず、25文字まで印字可能
