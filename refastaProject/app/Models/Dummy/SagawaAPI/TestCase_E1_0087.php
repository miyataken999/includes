...
class TestCase_E1_0087
{
    ...
    public function set()
    {
        ...
        $this->shukaIraiCode = '130003750009-75r84'; // 必須:×項番:1-7-1-47-1階層:5属性:半角数字桁数:12桁数:12項目名:集荷依頼主コード備考:集荷依頼の場合必須 ---集荷依頼を利用する配送会社との契約コード ---チェックデジット含みます
