...
class TestCase_E1_0003
{
    ...
    public function set()
    {
        ...
        $this->kokyakuCode = '930003750001'; // 必須:◎項番:1-7-1-3階層:4属性:半角数字桁数:12桁数:12項目名:顧客コード備考:配送会社との契約コード ---チェックデジット含みます
