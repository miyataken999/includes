...
trait ConvertMediaTrait
{
    ...
    {
        // kinkai convert
        $kinkaiGetMedia = $this->get_media('kinkai_lounge');
        $this->upsertNewWPMedia($kinkaiGetMedia, 'kinkai_lounge');

        // brakai convert
        $brakaiGetMedia = $this->get_media('brakai_lounge');
        $this->upsertNewWPMedia($brakaiGetMedia, 'brakai_lounge');

    }

    /**
     * lounge WPからMediaデータを取得
     * @param string $convert_type
     * @return Collection
     */
    public function get_media(string $convert_type): Collection
    {
        ...
        $Media = DB::table($table)->where('post_type', 'attachment')->get();
        return $Media;
    }
     ...
     * @return bool
     */
    public function upsertNewWPMedia(Collection $items, string $convert_type): bool
    {
