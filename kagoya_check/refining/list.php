<?
header('location: https://rifa.life/evaProject/eva_reflect/Eoc_refining/');
exit;

// ini_set("display_errors",1);
$table_name = "Eoc_refining";
if($_GET["table_name"] != ""){
...
<?
	...
	$query = "SELECT internet.{$table_name}.*
...
?>
		...
		<td class="td_<?=$column_name[$column_i]?> col_<?=$column_name[$column_i]?>"></td>
