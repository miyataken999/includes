...
if($_GET["reset"] == "on"){
	...
	if(($freely_write_text != "") OR ($a_word_text != "")){
		$subject .= "<tr>";
		$subject .= "<th colspan='2'>ご要望・ご指摘</th>";
		$subject .= "</tr>";
		$subject .= "<tr>";
		$subject .= "<td colspan='2'>{$freely_write_text}</td>";
		$subject .= "<tr>";
		$subject .= "<th colspan='2'>担当者に一言</th>";
		$subject .= "</tr>";
		$subject .= "<tr>";
		$subject .= "<td colspan='2'>{$a_word_text}</td>";
		$subject .= "</tr>";
	}
	...
	if(($site_level != "") OR ($choice_reason_text != "")){
		$subject .= "<tr>";
		$subject .= "<th colspan='2'>選んだ理由</th>";
		$subject .= "</tr>";
		$subject .= "<tr>";
		$subject .= "<td colspan='2'>{$choice_reason_text}</td>";
		$subject .= "</tr>";
	}
	$subject .= "</table>";
...
<div id="form_back">
  ...
  <script>
    ...
    CKEDITOR.replace('subject', {
      ...
      height: 500,
      // エディタ内に適用するCSS
      // contentsCss: "https://rifa.life/include/kagoya_check/guestquestion/eoc_after_data_table/voice_edit.css",
      // スペルチェック機能OFF
