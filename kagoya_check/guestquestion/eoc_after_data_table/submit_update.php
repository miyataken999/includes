...
$up_col .= ",EOC_COURIER_CHECK='{$guestquestion_check}'";
...
if($ecc_id != ""){
	...
	if (!$sql) {
	    ...
	    //チャットワーク流す
		$text_table = "[info][title]Eoc自動反映クエリ失敗 ■ Eocguestquestion UPDATE[/title]";
		...
		include $_SERVER["DOCUMENT_ROOT"]."/include/kagoya_check/guestquestion/eoc_after_data_table/move_to_eva.php";
	}
