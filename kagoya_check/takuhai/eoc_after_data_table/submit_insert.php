...
$into_col .= ',ecc_seq';
$into_col .= ',kit_flag';
$into_col .= ',is_exist_haisouhosyo';

$is_exist_haisouhosyo = "";
if($insurance_kingaku > 0){
	$is_exist_haisouhosyo = 1;
}
...
$last_id = mysql_insert_id();
	...
	if(!empty($timeline_text)) {
		$timeline_text = str_replace("★time★",$cv_time,$timeline_text);
		$timeline_query = "INSERT INTO internet.Eoc_timeline (ecc_id, category, title, detail, create_at) VALUES({$last_id}, 9, '宅配', '{$timeline_text}', NOW())";
		mysql_query($timeline_query);
	}
