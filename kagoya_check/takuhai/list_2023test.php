...
?>
		<td class="td_<?=$column_name[$column_i]?> col_<?=$column_name[$column_i]?>"><span><a href='/include/kagoya_check/takuhai/hikaku_list_2023test.php?hikaku_id=<?=$column_val?>' >対象発掘</a></span></td>
<?
}
?>
