...
if($_GET["hikaku_id"] != ""){
	...
	print "対象データがありません。<a href='/include/kagoya_check/takuhai_test/Eoc_takuhai_list.php?table_name=Eoc_takuhai'>一覧ページに戻る</a>";
	exit();
}
...
<div id="sousin_name_box">
	...
	<form action="/include/kagoya_check/takuhai_test/eoc_after_data_table/eoc_after_data_table.php" method="get" accept-charset="utf-8">
		<input type="hidden" name="hikaku_id" value="<?=$hikaku_id?>">
...
<div class="return_btn">
	<a href="/include/kagoya_check/takuhai_test/list.php" >一覧へ戻る</a>
</div>
