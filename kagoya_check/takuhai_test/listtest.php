...
include $_SERVER["DOCUMENT_ROOT"]."/include/connection.php";
		...
		while ($result = mysql_fetch_assoc($sql)) {
			if(($result["GroupID"] == '3') OR ($result["GroupID"] == '-1')){
				$ok_user = "ok";
			}
		}
		if($ok_user == "no"){
...
<?
if($result["ecc_id"] >0 ){
	$ecc_link = "http://urlounge.co.jp/include/kagoya_check/takuhai/eoc_after_data_table/eoc_after_data_tabletest.php?hikaku_id={$result['id']}&uid={$uid}&kousin_id={$result['ecc_id']}";
