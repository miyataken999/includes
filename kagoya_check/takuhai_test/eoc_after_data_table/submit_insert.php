...
$query = "INSERT INTO internet.Eoc_copy_tamiya_test{$into_col}VALUES{$into_val}";
// print $query;
$sql = mysql_query('SET NAMES utf8');
$sql = mysql_query($query);
...
$last_id = mysql_insert_id();
	...
	$last_query = "UPDATE internet.Eoc_copy_tamiya_test SET updated_at=NOW() WHERE ecc_id={$last_id} ";
	...
	if (!$sql) {
		...
		include $_SERVER["DOCUMENT_ROOT"]."/include/kagoya_check/takuhai_test/eoc_after_data_table/move_to_eva.php";
