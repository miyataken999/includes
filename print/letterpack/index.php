...
if(($_SERVER["REMOTE_ADDR"] == '35.189.145.255') && ($_GET["rifa_load"] == "on")){
	...
	$title = "分割加工預かり証の発送のご連絡";
	$message = "
	お世話になっております。リファスタと申します。<br>
	この度は【金地金精錬分割加工サービス配送タイプ】のご利用、<br>
	誠にありがとうございます。<br>
	表題の件につきまして、お客様の分割加工預かり証を<br>
	発送させていただきますので、お受け取りくださいませ。<br>
	何卒、よろしくお願い申し上げます。
	";
	...
	//API URL
	$url="http://rifa.life/lounge_API/wkhtml/wkhtml.php";
	//キャプチャ取得のURL
	$flag_name = "letterpack_flag";
	$get_url = "https://rifa.life/include/print/letterpack/index.php?ecc_id={$ecc_id}&uid={$uid}&flag={$flag_name}&rifa_load=on";
	//アップロード時のファイル名
