...
// phpinfo();
//ログイン認証
if((($_SERVER["REMOTE_ADDR"] == '35.189.145.255') && ($_GET["rifa_load"] == "on")) OR ($_GET["nishitani"] == "on")){
	...
	//キャプチャ取得のURL
	$get_url = "https://rifa.life/include/print/refining/deposit.php?ecc_id={$ecc_id}&uid={$uid}&rifa_load=on";
	//アップロード時のファイル名
