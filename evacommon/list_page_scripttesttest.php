...
togtog();
<?
}elseif((stristr($current_page_pass, "satei_of_jewelry_list.php"))or(stristr($current_page_pass, "market_product_performance_original_list.php"))){
?>
function togtog(){
...
<div class="batch_popup_back">
	<div class="batch_popup_box">
		<form class = "batch_form" action="/include/evacommon/list_page_batchtesttest.php" method="post">
			...
			<div class="float-left">
				<h4>▼処理内容▼</h4>
					...
					if(stristr($current_page_pass, "shouhin_batch_list.php")){
						...
						$select_box = "<option value=\"chohyo_touroku_seihin\">帳票登録 製品test</option>";
					}elseif(stristr($current_page_pass, "chohyo_by_dia_list.php")){
						$select_box = "<option value=\"chohyo_touroku_dia\">帳票登録 ダイア</option>";
					}//if end
			?>
