...
//★★★★楽天 item.csv★★★★
include $_SERVER["DOCUMENT_ROOT"]."/include/zip/process/multiple/rakuten/item_csv.php";
?>
...
<?
//★★★★楽天 item-cat.csv★★★★
include $_SERVER["DOCUMENT_ROOT"]."/include/zip/process/multiple/rakuten/item-cat_csv.php";
?>
...
<?
//★★★★楽天 select.csv★★★★
include $_SERVER["DOCUMENT_ROOT"]."/include/zip/process/multiple/rakuten/select_csv.php";
?>
...
<?
//★★★★楽天 next.csv★★★★
include $_SERVER["DOCUMENT_ROOT"]."/include/zip/process/multiple/rakuten/next_csv.php";
?>
...
//★★★★yahoo  csv★★★★
include $_SERVER["DOCUMENT_ROOT"]."/include/zip/process/multiple/yahoo/yahoo_auction_csv.php";
?>
...
for ($box_iiii=0; $box_iiii < count($box_id_array); $box_iiii++) {
	...
	if($box_name != ""){
		$yahoo_zip_res = system("zip tmp/yahoo_zip/yahoo_{$box_id_default}.zip -j ./tmp/yahoo/{$box_id_default}.csv {$image_pass}*.jpg ", $re_yahoo_zip); //{$box_name}/
...
<div id="link_box_back">
	<div id="link_box">
		<h3>ZIP作成に成功しました</h3>
		<a target="_blank" href='/include/zip/rakuten_download.php?box_name=<?=$box_id_default?>' >楽天ZIPダウンロード</a>
		<a target="_blank" href='/include/zip/yahoo_download.php?box_name=<?=$box_id_default?>' >ヤフオクZIPダウンロード</a>
	</div>
<?
//完了時のファイル
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
...
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
//ST変更の。本番化でコメントアウト外す
// include $_SERVER[DOCUMENT_ROOT]."/include/zip/make_after/last_process.php";
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
//★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★
?>
