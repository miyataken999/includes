...
//boxからのstore_products反映の特殊ログファイル
...
$syuppin_query = " UPDATE store_products SET Exhibition_Date='{$now}' , REG_EXHIBITOR='{$user_id}' , updated_at='{$now}' , updated_by='{$user_id}'  WHERE box_id={$box_id} ";
