...
//+++++++++++++++++++++++++++++++++++++++
$field_name .= " , store_products.product_id , store_products.sub_category_id1 , store_products.category_id , store_products.yahoo_condition2 , store_products.Finish ";
//+++++++++++++++++++++++++++++++++++++++
//CSVデータをひっぱる
//+++++++++++++++++++++++++++++++++++++++
...
//ファイル作成
$file_pass = "./tmp/yahoo/{$box_name}.csv";
				...
				if($field_name_array[$field_i] != ""){
					//★★★★★★★★★★★★★★★★★★★★★★★★テンプレート処理★★★★★★★★★★★★★★★★★★★★★★★
						if($field_name_array[$field_i] == "tmp_yahoo"){
							$temp_pc = file_get_contents("http://urlounge.co.jp/shop/zip/combra/yahoo_template/1609.php?product_id=".$result["product_id"]);
