...
while($data = $button->getNextSelectedRecord()){
	...
	// $up_id = $data["chigin_id"];
	// if($up_id > 0){
	// 	$sql = "UPDATE Eoc_chigins2 SET label_output_flag = 1 , updated_by = {$uid} , update_at = {$time} WHERE chigin_id = {$up_id}";
	// 	// error_log($sql,1,"nishitani@urlounge.co.jp");
	// 	CustomQuery($sql);

	// 	$chigin_id_list_array[] = $up_id;
	// }
...
// $chigin_id_list = implode(",\n",$chigin_id_list_array);
