...
while($data = $button->getNextSelectedRecord()){
	...
	$up_chohyo_id = $data["chohyo_id"];
	$sql = "UPDATE shouhin SET chohyo_id = '{$up_chohyo_id}' ,updated_by = {$uid} , updated_at = {$time} WHERE product_id = {$up_id}";
	CustomQuery($sql);
	...
	//-------追加ログ全てのパターン
	$log_text .= "chohyo_id[new]:{$up_chohyo_id}\n";
