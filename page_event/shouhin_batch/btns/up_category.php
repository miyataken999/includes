...
while($data = $button->getNextSelectedRecord()){
  ...
  $up_category_id = $data["category_id"];
  $up_sub_category_id1 = $data["sub_category_id1"];
	$sql = "UPDATE shouhin SET category_id = '{$up_category_id}' , sub_category_id1 = '{$up_sub_category_id1}' ,updated_by = {$uid} , updated_at = {$time} WHERE product_id = {$up_id}";
	CustomQuery($sql);
	...
	//-------追加ログ全てのパターン
  $log_text .= "category_id[new]:{$up_category_id}\n";
  $log_text .= "sub_category_id1[new]:{$up_sub_category_id1}\n";
