...
while($data = $button->getNextSelectedRecord()){
	...
	$up_identification_cost = $data["identification_cost"];
	$sql = "UPDATE shouhin SET identification_cost = '{$up_identification_cost}' ,updated_by = {$uid} , updated_at = {$time} WHERE product_id = {$up_id}";
	CustomQuery($sql);
	...
	//-------追加ログ全てのパターン
	$log_text .= "identification_cost[new]:{$up_identification_cost}\n";
