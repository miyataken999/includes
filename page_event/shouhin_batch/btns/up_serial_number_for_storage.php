...
while($data = $button->getNextSelectedRecord()){
	...
	$up_serial_number_for_storage = $data["serial_number_for_storage"];
	$sql = "UPDATE shouhin SET serial_number_for_storage = '{$up_serial_number_for_storage}' ,updated_by = {$uid} , updated_at = {$time} WHERE product_id = {$up_id}";
	CustomQuery($sql);
	...
	//-------追加ログ全てのパターン
	$log_text .= "serial_number_for_storage[new]:{$up_serial_number_for_storage}\n";
