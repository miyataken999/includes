...
while($data = $button->getNextSelectedRecord()){
	...
	if(($price_secret == "")and($data['price'] != "")){
		$price = $data['price'];
		$price_secret = file_get_contents("http://rifa.life/lounge_API/evaeva/create_price_ingo.php?price={$price}");
	}

	if(($sales_price_secret == "")and($data['sales_price'] != "")){
		$sales_price = $data['sales_price'];
		$sales_price_secret = file_get_contents("http://rifa.life/lounge_API/evaeva/create_price_ingo.php?price={$sales_price}");
	}
