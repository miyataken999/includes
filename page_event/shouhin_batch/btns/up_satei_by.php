...
while($data = $button->getNextSelectedRecord()){
	...
	$up_satei_by = $data["satei_by"];
	$sql = "UPDATE shouhin SET satei_by = '{$up_satei_by}' ,updated_by = {$uid} , updated_at = {$time} WHERE product_id = {$up_id}";
	CustomQuery($sql);
	...
	//-------追加ログ全てのパターン
	$log_text .= "satei_by[new]:{$up_satei_by}\n";
