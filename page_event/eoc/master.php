...
?>
		...
		$link_btn += '<a class="rnr-button btn btn-douga" href="/include/mail/input.php?tmp_id=193&ecc_id=<?=$masterkey1?>" typeid="ib">動画付き査定</a>';
		...
		// $link_btn += '<a href="#" class="rnr-button btn btn-primary" onclick="autoOutputLabelWindow();">自動ラベル</a>';
		$link_btn += '<a href="#" class="rnr-button btn btn-warning" onclick="outputLabelWindow();">査定ラベル発行</a>';


<?
}elseif(!stristr($current_page_pass, "Eoc_trader")){
?>
		$link_btn += '<a class="rnr-button btn btn-gold" href="/include/mail/input.php?tmp_id=136&ecc_id=<?=$masterkey1?>" typeid="ib">査定</a>';
		$link_btn += '<a class="rnr-button btn btn-blue" href="/include/mail/input.php?tmp_id=146&ecc_id=<?=$masterkey1?>" typeid="ib">全部なし査定</a>';
		$link_btn += '<a class="rnr-button btn btn-douga" href="/include/mail/input.php?tmp_id=193&ecc_id=<?=$masterkey1?>" typeid="ib">動画付き査定</a>';
