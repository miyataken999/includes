<?php
	...
	$html .= "<table class='Eoc_details_table shop_front_content'>";
	$html .= "<tr>";
	$html .= "<th>店頭入力情報</th>";
	$html .= "<td><a href ='https://rifa.life/kagoya/shop_front_details_list.php?q=(ecc_id~equals~".$data["ecc_id"].")' target='_blank'>https://rifa.life/kagoya/shop_front_details_list.php?q=(ecc_id~equals~".$data["ecc_id"].")</a></td>";
	$html .= "</tr>";
	$html .= "</table>";
	...
	$html .= "<table class='Eoc_details_table' >";
		...
		$html .= "<tr>";
			...
			$val = str_replace("<br><br>","<br>",$val);
			$val = str_replace("ダンボール","<br>ダンボール",$val);
			$html .= $val;
			$val = '';
			$html .= "</span></td>";
		...
		$html .= "<tr>";
			...
			$html .= "<th><span>キット時間帯指定</span></th>";
			$html .= "<th><span>集荷希望日</span></th>";
			$html .= "<th><span>集荷希望時間帯</span></th>";
		...
		$html .= "<tr>";
			...
			$html .= "<td><span>";
			$EOC__DATE_AND_TIME_2 = $data["EOC__DATE_AND_TIME_2"];
			$EOC__DATE_AND_TIME_2 = str_replace("- ", " ", $EOC__DATE_AND_TIME_2);
			$EOC__DATE_AND_TIME_2 = str_replace(" ", "<br>", $EOC__DATE_AND_TIME_2);
			$EOC__DATE_AND_TIME_2 = str_replace("00:00:00", "", $EOC__DATE_AND_TIME_2);
			$html .= $EOC__DATE_AND_TIME_2;
			$html .= "</span></td>";
			...
			$html .= str_replace("\n","<br>",$data["bank_name"]);
			$html .= "<br>半角名義人：" . $data["meigi_hankaku_kana"];
			$html .= "</span></td>";
		$html .= "</tr>";
		$html .= "<tr>";
