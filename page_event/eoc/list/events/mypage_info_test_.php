...
$idfile_check_html .= "<tr><th colspan=5>【身分証アップ状況】<a class='btn btn-success' href = 'https://rifa.life/evaProject/mypage/id_fileupload/ecc_id/{$ecc_id}'>身分証アップ画面リンク</a></th></tr></div>";
