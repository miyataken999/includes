...
window.onload = function(){
	console.log("onload")
	var append_html = '<div class="btn btn-primary " id="btn-top-save">保存</div>'
  document.querySelector('div[data-brick="editfields"] .container').nextElementSibling.nextElementSibling.insertAdjacentHTML('afterbegin',append_html);

  document.getElementById('btn-top-save').onclick = function(){
