...
<?
	...
	$query = ' SELECT product_id , status , yahoo_sinaban , yahoo_title , sales_price FROM shouhin WHERE box_id = '.$box_id;
...
?>
	<tr id="toprow_<?=$result['product_id']?>">
		...
		<td>楽天</td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_1.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_1.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_2.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_2.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_3.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_3.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_4.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_4.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_5.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_5.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_6.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_6.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_7.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_7.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_8.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_8.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_9.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_9.jpg" alt="" width="10px" height="10px" ></a></td>
		<td><a href="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_10.jpg" target="_blank"><img src="http://thumbnail.image.rakuten.co.jp/@0_mall/rfstore/cabinet/<?=$img_pass?>/<?=$result['product_id']?>_10.jpg" alt="" width="10px" height="10px" ></a></td>
	</tr>
