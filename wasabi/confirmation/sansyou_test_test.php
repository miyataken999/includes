...
?>
<form action="./sansyou_test_test.php" method="get" accept-charset="utf-8">
...
?>
<form id="main_form" action="./makecsv_test_test.php" method="post">
...
<?
  ...
  shouhin.cost,
	...
	shouhin.other_cost,
  shouhin.auto_price_cut_prohibited,
	shouhin.box_sort,
...
?>
	<tr id="toprow_<?=$result['product_id']?>" class="kaigai_<?=$kaigaiflag?>">
		<td rowspan="2" style="border-bottom:5px solid #111; text-align:center;"><?=$result['box_sort']?></td>
		<td>
			<?=$result['product_id']?>
      ...
      <input type="hidden" name="<?=$result['product_id']?>###auto_price_cut_prohibited" value="<?=$result['auto_price_cut_prohibited']?>">
      <input type="hidden" name="<?=$result['product_id']?>###cost" value="<?=$result['cost']?>">
			<input type="hidden" name="<?=$result['product_id']?>###identification_cost" value="<?=$result['identification_cost']?>">
			<input type="hidden" name="<?=$result['product_id']?>###other_cost" value="<?=$result['other_cost']?>">
      <input type="hidden" name="<?=$result['product_id']?>###price" value="<?=$result['price']?>">
			<input type="hidden" name="<?=$result['product_id']?>###itaku_flag" value="<?=$result['itaku_flag']?>">
		</td>
		<td>
