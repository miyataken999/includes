...
<?
	$query = ' SELECT product_id , status , yahoo_sinaban , yahoo_title , sales_price , box_id FROM store_products WHERE product_id = '.$seq.' LIMIT 1';
...
?>
<form id="zip_edit_area" action="/include/zip/makezip_tanpin.php" method="get" accept-charset="utf-8">
