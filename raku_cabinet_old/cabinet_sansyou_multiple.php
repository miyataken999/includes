...
<?
	include $_SERVER["DOCUMENT_ROOT"]."/include/raku_cabinet/multiple_box_inc.php";
}
?>
	</table>
...
?>
<form id="zip_edit_area" action="/include/zip/makezip_multiple.php" method="get" accept-charset="utf-8">
