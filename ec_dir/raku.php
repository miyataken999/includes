...
var r_dir_5 = "";
	...
	$("#id_res_btn").click(function() {
		...
		id_raku_dir_load_area.load("/include/ec_dir/raku_dir_select.php?r_dir_1="+r_dir_1+"&r_dir_2="+r_dir_2+"&r_dir_3="+r_dir_3+"&r_dir_4="+r_dir_4+"&r_dir_5="+r_dir_5,function(){
			...
			console.log("res_id_count "+res_id_count);
			if(res_id_count == 1){
				if(result_id != ""){
					$("#tag_check_area").load("/include/shuppin/rakuten/tag_get/get.php?genreId="+$("#result_id").text()+"&product_id="+$("#seq_td").text(),function(response, status, xhr){
