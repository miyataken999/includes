...
$housyoku_array = array(10,12,17,18,19,50,20,51,21,22,23);
...
while($res = mysql_fetch_assoc($shouhin_rs)){
    ...
    if(!(isset($market_res['product_id']))){
      $market_insert_sql = "INSERT INTO `market_product_performance_original` (`product_id`,`front_hidden_flg`) VALUES ('$product_id','true')";
