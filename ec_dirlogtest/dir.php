...
<head>
	...
	<link rel="stylesheet" href="/include/ec_dirlogtest/dir.css">
</head>
<body>
<?
...
<div class="preview_box">
	<a href="/include/rakuten_template/pc/temp.php?product_id=<?=$product_id?>" target="_blank">楽天プレビュー</a>
	<a href="/include/yahoo_template/temp.php?product_id=<?=$product_id?>" target="_blank">ヤフオクプレビュー</a>
</div>
<?
...
<?include $_SERVER["DOCUMENT_ROOT"]."/include/ec_dirlogtest/raku.php";?>
...
<?include $_SERVER["DOCUMENT_ROOT"]."/include/ec_dirlogtest/yahoo.php";?>
</div><!-- end yahoo_dir_ara -->


<?
//宝飾、服飾の大カテを分ける為
$housyoku_group_id = array(18,19,20,21,22,23,25,26,27,28);
//宝飾以外（服飾のカテゴリーだったら、タグを選択しないため）
if(!in_array($category_id,$housyoku_group_id)){
?>
<input id="judgment_btn_sub" type="button" name="a" value="ディレクトリ決定！">
<?
}
?>
...
var user_id = "<?=$user_id?>";
	...
	$("#judgment_btn_sub").click(function(event) {
		$("#last_check_area").load("/include/ec_dirlogtest/last_check_shop5.php");
	});
