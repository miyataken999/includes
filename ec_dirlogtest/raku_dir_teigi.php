...
var id_value_raku_dir_1_1_val = "";
var id_value_raku_dir_2_1_val = "";
var id_value_raku_dir_3_1_val = "";
var id_value_raku_dir_4_1_val = "";
var id_value_raku_dir_5_1_val = "";

var id_value_product_num_1_val = "<?=$product_num?>";
var id_brand_kashira_val = "<?=$seach_j?>";


var daikate = "<?=$category_id?>";
var tyuukate = "<?=$st_yahoo_sex?>";
var sex = "<?=$sub_category_id1?>";

console.log(daikate);
console.log(tyuukate);
console.log(sex);
console.log(id_value_product_num_1_val);
console.log(id_brand_kashira_val);
...
$("#raku_auto_1").click(function(){
	raku_dir_auto_1();
})


function raku_dir_auto_1(){
//第一階層
<?
$teigi_sql = mysql_query('SET NAMES utf8');
$teigi_sql = mysql_query("SELECT * FROM mst_raku_teigi_1 ORDER BY dir_1_id");
//定義の合計数
$teigi_sum = 0;
$teigi = "";
while ($dir_teigi_res = mysql_fetch_assoc($teigi_sql)) {
	if(($dir_teigi_res["name_1"] != "" ) &&($dir_teigi_res["value_1"] != "" )){
		...
		if(($dir_teigi_res["conjunction_9"] != "" ) && ($dir_teigi_res["name_9"] != "" ) && ($dir_teigi_res["value_9"] != "" )){
			...
			//定義の中の動作
			$teigi .= "){";
			$teigi .= "id_value_raku_dir_1_1.val(\"".$dir_teigi_res["dir_1_name"]."\");";
			$teigi .= "id_value_raku_dir_1_1.change();";
			$teigi .= "}";
...
$("#raku_auto_2").click(function(){
	raku_dir_auto_2();
})
function raku_dir_auto_2(){
//第二階層
	id_value_raku_dir_1_1_val = $("#value_raku_dir_1_1").val();

<?
$teigi_sql_2 = mysql_query('SET NAMES utf8');
$teigi_sql_2 = mysql_query("SELECT dir_1_name , dir_2_name , name_1 , value_1 , conjunction_2 , name_2 , value_2 FROM mst_raku_teigi_2 ORDER BY dir_2_id");
//定義の合計数
$teigi_sum = 0;
$teigi = "";
while ($dir_teigi_res_2 = mysql_fetch_assoc($teigi_sql_2)) {
	if(($dir_teigi_res_2["name_1"] != "" ) &&($dir_teigi_res_2["value_1"] != "" )){
		...
		//定義の中の動作
		$teigi .= ") && (id_value_raku_dir_1_1_val == \"".$dir_teigi_res_2["dir_1_name"]."\") ){";
		$teigi .= "id_value_raku_dir_2_1.val(\"".$dir_teigi_res_2["dir_2_name"]."\");";
		$teigi .= "id_value_raku_dir_2_1.change();";
		$teigi .= "}";
		$teigi_sum++;
	}
?>
...
$("#raku_auto_3").click(function(){
	raku_dir_auto_3();
})
function raku_dir_auto_3(){
//第三階層
	id_value_raku_dir_1_1_val = id_value_raku_dir_1_1.val();
	id_value_raku_dir_2_1_val = id_value_raku_dir_2_1.val();


<?
$teigi_sql_3 = mysql_query('SET NAMES utf8');
$teigi_sql_3 = mysql_query("SELECT dir_1_name , dir_2_name , dir_3_name , name_1 , value_1 , conjunction_2 , name_2 , value_2 , conjunction_3 , name_3 , value_3 , brand_junle FROM mst_raku_teigi_3 ORDER BY dir_3_id");
//定義の合計数
$teigi_sum = 0;
$teigi = "";
while ($dir_teigi_res_3 = mysql_fetch_assoc($teigi_sql_3)) {
	if(($dir_teigi_res_3["name_1"] != "" ) &&($dir_teigi_res_3["value_1"] != "" )){
		...
		if($dir_teigi_res_3["name_1"] == "seach_j"){
			$teigi .= "(id_brand_kashira_val == \"".$dir_teigi_res_3["value_1"]."\")";
		}else{
		...
		if(($dir_teigi_res_3["conjunction_2"] != "" ) && ($dir_teigi_res_3["name_2"] != "" ) && ($dir_teigi_res_3["value_2"] != "" )){
			...
			if($dir_teigi_res_3["name_2"] == "seach_j"){
				$teigi .= $conjunction_2."(id_brand_kashira_val == \"".$dir_teigi_res_3["value_2"]."\")";
			}else{
		...
		if(($dir_teigi_res_3["conjunction_3"] != "" ) && ($dir_teigi_res_3["name_3"] != "" ) && ($dir_teigi_res_3["value_3"] != "" )){
			...
			if($dir_teigi_res_3["name_3"] == "seach_j"){
				$teigi .= $conjunction_3."(id_brand_kashira_val == \"".$dir_teigi_res_3["value_3"]."\")";
			}else{
		...
		//定義の中の動作
		$teigi .= ") && (id_value_raku_dir_1_1_val == \"".$dir_teigi_res_3["dir_1_name"]."\") && (id_value_raku_dir_2_1_val == \"".$dir_teigi_res_3["dir_2_name"]."\") ";
		if($dir_teigi_res_3["brand_junle"] != ""){
			$teigi .= " && (id_value_product_num_1_val == \"".$dir_teigi_res_3["brand_junle"]."\") ";
		}
		$teigi .= "){";
		$teigi .= "id_value_raku_dir_3_1.val(\"".$dir_teigi_res_3["dir_3_name"]."\");";
		$teigi .= "id_value_raku_dir_3_1.change();";
		$teigi .= "}";
		$teigi_sum++;
...
$("#raku_auto_4").click(function(){
	raku_dir_auto_4();
})
function raku_dir_auto_4(){
//第四階層
	id_value_raku_dir_1_1_val = id_value_raku_dir_1_1.val();
	id_value_raku_dir_2_1_val = id_value_raku_dir_2_1.val();
	id_value_raku_dir_3_1_val = id_value_raku_dir_3_1.val();


<?
$teigi_sql_4 = mysql_query('SET NAMES utf8');
$teigi_sql_4 = mysql_query("SELECT dir_1_name , dir_2_name , dir_3_name , dir_4_name , name_1 , value_1 , conjunction_2 , name_2 , value_2 , conjunction_3 , name_3 , value_3 , brand_junle FROM mst_raku_teigi_4 ORDER BY dir_4_id");
//定義の合計数
$teigi_sum = 0;
$teigi = "";
while ($dir_teigi_res_4 = mysql_fetch_assoc($teigi_sql_4)) {
	if(($dir_teigi_res_4["name_1"] != "" ) &&($dir_teigi_res_4["value_1"] != "" )){
		...
		if($dir_teigi_res_4["name_1"] == "seach_j"){
			$teigi .= "(id_brand_kashira_val == \"".$dir_teigi_res_4["value_1"]."\")";
		}else{
		...
		if(($dir_teigi_res_4["conjunction_2"] != "" ) && ($dir_teigi_res_4["name_2"] != "" ) && ($dir_teigi_res_4["value_2"] != "" )){
			...
			if($dir_teigi_res_4["name_2"] == "seach_j"){
				$teigi .= $conjunction_2."(id_brand_kashira_val == \"".$dir_teigi_res_4["value_2"]."\")";
			}else{
		...
		if(($dir_teigi_res_4["conjunction_3"] != "" ) && ($dir_teigi_res_4["name_3"] != "" ) && ($dir_teigi_res_4["value_3"] != "" )){
			...
			if($dir_teigi_res_4["name_3"] == "seach_j"){
				$teigi .= $conjunction_3."(id_brand_kashira_val == \"".$dir_teigi_res_4["value_3"]."\")";
			}else{
		...
		//定義の中の動作
		$teigi .= ") && (id_value_raku_dir_1_1_val == \"".$dir_teigi_res_4["dir_1_name"]."\") && (id_value_raku_dir_2_1_val == \"".$dir_teigi_res_4["dir_2_name"]."\") && (id_value_raku_dir_3_1_val == \"".$dir_teigi_res_4["dir_3_name"]."\") ";
		if($dir_teigi_res_4["brand_junle"] != ""){
			$teigi .= " && (id_value_product_num_1_val == \"".$dir_teigi_res_4["brand_junle"]."\") ";
		}
		$teigi .= "){";
		$teigi .= "id_value_raku_dir_4_1.val(\"".$dir_teigi_res_4["dir_4_name"]."\");";
		$teigi .= "id_value_raku_dir_4_1.change();";
		$teigi .= "}";
		$teigi_sum++;
...
$("#raku_auto_5").click(function(){
	raku_dir_auto_5();
})
function raku_dir_auto_5(){
//第五階層
	id_value_raku_dir_1_1_val = id_value_raku_dir_1_1.val();
	id_value_raku_dir_2_1_val = id_value_raku_dir_2_1.val();
	id_value_raku_dir_3_1_val = id_value_raku_dir_3_1.val();
	id_value_raku_dir_4_1_val = id_value_raku_dir_4_1.val();


<?
$teigi_sql_5 = mysql_query('SET NAMES utf8');
$teigi_sql_5 = mysql_query("SELECT dir_1_name , dir_2_name , dir_3_name , dir_4_name , dir_5_name , name_1 , value_1 , conjunction_2 , name_2 , value_2 , brand_junle FROM mst_raku_teigi_5 ORDER BY dir_5_id");
//定義の合計数
$teigi_sum = 0;
$teigi = "";
	...
	if(($dir_teigi_res_5["name_1"] != "" ) &&($dir_teigi_res_5["value_1"] != "" )){
		...
		if($teigi_sum != 0){
			...
			if($dir_teigi_res_5["name_2"] == "seach_j"){
				$teigi .= "(id_brand_kashira_val == \"".$dir_teigi_res_5["value_2"]."\")";
			}else{
		...
		if(($dir_teigi_res_5["conjunction_2"] != "" ) && ($dir_teigi_res_5["name_2"] != "" ) && ($dir_teigi_res_5["value_2"] != "" )){
			...
			if($dir_teigi_res_5["name_2"] == "seach_j"){
				$teigi .= $conjunction_2."(id_brand_kashira_val == \"".$dir_teigi_res_5["value_2"]."\")";
			}else{
		...
		//定義の中の動作
		$teigi .= ") && (id_value_raku_dir_1_1_val == \"".$dir_teigi_res_5["dir_1_name"]."\") && (id_value_raku_dir_2_1_val == \"".$dir_teigi_res_5["dir_2_name"]."\") && (id_value_raku_dir_3_1_val == \"".$dir_teigi_res_5["dir_3_name"]."\") && (id_value_raku_dir_4_1_val == \"".$dir_teigi_res_5["dir_4_name"]."\") ";
		if($dir_teigi_res_5["brand_junle"] != ""){
			$teigi .= " && (id_value_product_num_1_val == \"".$dir_teigi_res_5["brand_junle"]."\") ";
		}
		$teigi .= "){";
		$teigi .= "id_value_raku_dir_5_1.val(\"".$dir_teigi_res_5["dir_5_name"]."\");";
		$teigi .= "id_value_raku_dir_5_1.change();";
		$teigi .= "}";
		$teigi_sum++;
...
id_value_raku_dir_5_1.change(function(){
	console.log("change id start!");
	$("#id_res_btn").click();
})
...
$("#edit1_raku_tag_result_0").prepend(tag_sel_area);
$("#tag_sel_btn").click(function(){
	var dir_id_res_num = $("#value_raku_dir_result_1").val();
	...
	if(dir_id_res_num != ""){
		// alert("ロードします");
            ...
            $.ajax({
                url: '/include/raku_tag/tag_res.php',
                type:'POST',
                dataType: 'json',
                data : {
                ...
                success: function(data) {
					...
					$("#value_raku_tag_result_1").focus(function(){
						var sel_res = "";
		...
		// $("#tag_sel").load("/include/raku_tag/tag_res.php?dir_id_res_num="+dir_id_res_num+"&brand="+brand_junle_name);
	}else{
