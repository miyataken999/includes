...
$("#edit1_raku_dir_5_0").prepend("<input id='raku_auto_5' type='button' value='自動入力5'><br>");
$("#edit1_raku_dir_4_0").prepend("<input id='raku_auto_4' type='button' value='自動入力4'><br>");
$("#edit1_raku_dir_3_0").prepend("<input id='raku_auto_3' type='button' value='自動入力3'><br>");
$("#edit1_raku_dir_2_0").prepend("<input id='raku_auto_2' type='button' value='自動入力2' ><br>");
$("#edit1_raku_dir_1_0").prepend("<input id='raku_auto_1' type='button' value='自動入力1' ><br>");
...
//第二階層
	...
	var sex = $("#value_st_yahoo_sex_1").val();
	var tyuukate = $("#value_sub_category_id1_1").val();
	var id_value_raku_dir_1_1_val = $("#value_raku_dir_1_1").val();
...
//第三階層
	...
	var tyuukate = $("#value_sub_category_id1_1").val();
	var id_value_raku_dir_1_1_val = $("#value_raku_dir_1_1").val();
	var id_value_raku_dir_2_1_val = $("#value_raku_dir_2_1").val();

	var id_value_product_num_1_val = $("#value_product_num_1").val();

	var id_brand_kashira_val = $("#brand_kashira").text();
...
//第四階層
	...
	var id_value_raku_dir_1_1_val = $("#value_raku_dir_1_1").val();
	var id_value_raku_dir_2_1_val = $("#value_raku_dir_2_1").val();
	var id_value_raku_dir_3_1_val = $("#value_raku_dir_3_1").val();
...
//第五階層
	...
	var id_value_raku_dir_2_1_val = $("#value_raku_dir_2_1").val();
	var id_value_raku_dir_3_1_val = $("#value_raku_dir_3_1").val();
	var id_value_raku_dir_4_1_val = $("#value_raku_dir_4_1").val();
