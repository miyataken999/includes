<?php
class eventclass_Eoc_catch  extends eventsBase
{
...
include $_SERVER["DOCUMENT_ROOT"].'/include/page_event/eoc_catch/add/process_record_values/index.php';
...
include $_SERVER["DOCUMENT_ROOT"].'/include/page_event/eoc_catch/edit/process_record_values/index.php';
;		
...
function BeforeMoveNextList(&$data, &$row, &$record, &$pageObject)
{
		...
		include $_SERVER["DOCUMENT_ROOT"].'/include/page_event/eoc_catch/list/after_record/index.php';
...
include $_SERVER["DOCUMENT_ROOT"].'/include/page_event/eoc_catch/edit/before_display/index.php';
;		
