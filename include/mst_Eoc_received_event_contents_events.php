<?php
class eventclass_mst_Eoc_received_event_contents  extends eventsBase
{
...
include $_SERVER["DOCUMENT_ROOT"].'/include/page_event/mst_Eoc_received_event_contents/list/after_record/index.php';
