...
(function ($, win) {
    ...
    $.fn.sudoSlider = function (optionsOrg) {
        ...
        var defaults = {
            ...
            prevHtml: '<a href="#" class="prevBtn"></a>', /* option[34]/*prevhtml*/ //@xlinesoft patched #7061
            nextHtml: '<a href="#" class="nextBtn"></a>', /* option[35]/*nexthtml*/ //@xlinesoft patched #7061
        ...
        return this.each(function () {
            ...
            function runOnImagesLoaded(target, waitForAllImages, callback) {
                ...
                elems.each(function () {
					...
					// @xlinesoft patch #7108
					if ( waitForAllImages && target.is('li') ) {
