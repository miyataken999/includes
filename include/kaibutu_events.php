<?php
class eventclass_kaibutu  extends eventsBase
{
...
include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/kaibutu/edit/after_record/index.php";
...
include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/kaibutu/edit/before_record/index.php";
//include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/saisun/edit/process_record_values/index.php";
...
//include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/saisun/edit/after_record/index.php";
//include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/saisun/edit/before_record/index.php";
include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/kaibutu/edit/process_record_values/index.php";
;		
