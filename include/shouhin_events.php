<?php
class eventclass_shouhin  extends eventsBase
{
...
//	onscreen events
		$this->events["shouhin_snippet"] = true;
...
include $_SERVER["DOCUMENT_ROOT"]."/include/page_event/shouhin/export/before_export/index.php";
...
//	onscreen events
function shouhin_snippet(&$params)
{
