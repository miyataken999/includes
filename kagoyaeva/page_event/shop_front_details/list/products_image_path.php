...
if($products_image_path != ""){
    ...
    if(isset($users['username'])){
        ...
        if(isset($kagoya_ugmembers['GroupID'])){
            $products_image_path = str_replace('/../../../../storage/app/public/', 'https://rifa.life/refasta_shop_front/storage/', $products_image_path);
            $products_image_path = str_replace('/../../../storage/app/public/', 'https://rifa.life/refasta_shop_front/storage/', $products_image_path);
            $products_image_path_array = explode("\n", trim($products_image_path));
            $value = "";
