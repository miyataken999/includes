...
class shouhin_tmp_data extends Model{

  public static $_table = 'shouhin_tmp_data';    // table name (異なる場合オーバライドできる)
  public static $_id_column = array('product_id','name');     // primary key (同様)
    ...
    public function log_save($old_dataArray='', $user_login='', $log_table='', $log_action='', $log_save_table='')
    {
      ...
      if($logText != ""){
          ...
          $logFirst .= "table_name:{$this->table_name}\n";
          $logFirst .= "field_name:{$this->field_name}\n";
          $logFirst .= "---Fields\n";
