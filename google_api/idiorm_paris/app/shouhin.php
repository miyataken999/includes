...
//■■■■■■■■■■■■■■■■■■■■■■■■■■■■■
  ...
  public function create_title(){
    ...
    if($this->self_DA_INTENSITY != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_INTENSITY;
		}
		if($this->self_DA_OVERTONE != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_OVERTONE;
		}
		if($this->self_DA_COLOR != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_COLOR;
		}
		if($this->self_DA_CLARITY != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_CLARITY;
		}
		if($this->self_DA_CUT != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_CUT;
		}
		if($this->self_DA_POLISH != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_POLISH;
		}
		if($this->self_DA_SYMMETRY != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_SYMMETRY;
		}
		if($this->self_DA_FLUO != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_FLUO;
		}
		if($this->self_DA_COLOR_FLUO != ""){
			if($raku_title != ""){$raku_title .= "/";}
			$raku_title .= $this->self_DA_COLOR_FLUO;
		}
  ...
  public function create_user_side_title(){
    ...
    if(($this->product_num != "") && ($this->product_num != 631)){
      $mst_brand = mst_brand::where('id', $this->product_num)->find_one();
      if($mst_brand != false){
        $brand_name = strstr($mst_brand->name,'/',true);
        $raku_title .= $brand_name;
      }
    }
    ...
    if($this->product_style != ""){
      if($this->product_style != 'etcその他雑貨'){
        if($raku_title != ''){$raku_title .= "･";}
        $raku_title .= $this->product_style;
      }
    }else{
    ...
    if($this->Gram != ""){
      if($raku_title != ''){$raku_title .= "-";}
      $raku_title .= $this->Gram;
      if($this->unit != ""){
        $raku_title .= $this->unit;
      }
    }
    ...
    $raku_dia_title = "";
    if($this->self_DA_INTENSITY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_INTENSITY;
    }elseif($this->DA_INTENSITY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_INTENSITY();
    }
    if($this->self_DA_OVERTONE != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_OVERTONE;
    }elseif($this->DA_OVERTONE != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_OVERTONE();
    }
    if($this->self_DA_COLOR != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_COLOR;
    }elseif($this->DA_COLOR != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_COLOR;
    }
    if($this->self_DA_CLARITY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_CLARITY;
    }elseif($this->DA_CLARITY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_CLARITY;
    }
    if($this->self_DA_CUT != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_CUT;
    }elseif($this->DA_CUT != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_CUT;
    }
    if($this->self_DA_POLISH != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_POLISH;
    }elseif($this->DA_POLISH != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_POLISH;
    }
    if($this->self_DA_SYMMETRY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_SYMMETRY;
    }elseif($this->DA_SYMMETRY != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_SYMMETRY;
    }
    if($this->self_DA_FLUO != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_FLUO;
    }elseif($this->DA_FLUO != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->DA_FLUO;
    }
    if($this->self_DA_COLOR_FLUO != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->self_DA_COLOR_FLUO;
    }elseif($this->DA_COLOR_FLUO != ""){
      if($raku_dia_title != ""){$raku_dia_title .= "/";}
      $raku_dia_title .= $this->mst_cofl();
    }
    if($raku_dia_title !=""){
      $raku_title .= "\n".$raku_dia_title."\n";
    }

    $raku_dia_after_title = "";
    if($this->Parent_stone != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $moji.$this->Parent_stone.'ct';
    }

    if($this->Aside_stone != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/FD:";}
      $raku_dia_after_title .= $this->Aside_stone.'ct';
    }

    if($this->Appraiser != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $this->Appraiser;
    }

    if($this->Ring_size != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $this->Ring_size;
    }

    if($this->Remarks != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $this->Remarks;
    }

    if($this->yahoo_kataban != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $this->yahoo_kataban;
    }

    if($this->serial_number_for_storage != ""){
      if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
      $raku_dia_after_title .= $this->serial_number_for_storage;
    }else{
      if($this->serial_number != ""){
        if($raku_dia_after_title != ''){$raku_dia_after_title .= "/";}
        $raku_dia_after_title .= $this->serial_number;
      }
    }

    if($raku_dia_after_title != ""){
      if($raku_dia_title == ""){$raku_title .= "/";}
      $raku_title .= $raku_dia_after_title;
    }
  ...
  **/
  ...
  public function set_buying_column($uid=0){
    if($this->status != 33){
      return 'ステータスが売却済(33)ではありません。 SEQ:'.$this->product_id;
    }
